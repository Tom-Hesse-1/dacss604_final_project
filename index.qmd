...
#removing circle mode
par(mar = c(0, 0, 0, 0))
gplot(g1.1,
      jitter = T)

#not much better
#using line segments instead of arrows for edges, since network is undirected
par(mar = c(0, 0, 0, 0))
gplot(g1.1,
      jitter = T,
      usearrows = F)

#still trying to make visualization more readable

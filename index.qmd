...
Geography can have strong associations with political ideologies. Scholars have identified a cleavage in political opinions of rural- and urban-dwelling Americans in recent years (Mettler & Brown, 2022; Savat, 2020). Rural voters strongly support Republican candidates (Gimpel et al., 2020), support greater restriction of the press (Mettler & Brown, 2022), and tend to be more resistant to new ideas in governance (Savat, 2020). Similar cleavages have been observed in other countries. Pairigi & Sartori (2014) found a similar cleavage based on geography in Italian national politics in the 1970s. Furthermore, Brookes & Cappellina have found evidence of a rural-urban divide in French politics in recent years. Significant evidence shows that geography can be a powerful force in politics, with the potential to cause harmful division.
